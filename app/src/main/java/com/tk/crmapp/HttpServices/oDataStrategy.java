...
public class oDataStrategy {
    private String endpoint;
    private String sessionToken;

    public oDataStrategy(@NonNull String endpoint, @NonNull String sessionToken) {
    ...
    public  oDataService getoDataService()
    {
        ...
        {
            synchronized (oDataStrategy.class) {
                if (odataservice == null) {
                    init();
                }
            }
    ...
    private Interceptor urlencodeInterceptor()
    {
        return chain -> {
